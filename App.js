...
function App() {
  ...
  let txtBuscar = "Salvar Runeterra";
  let txtFiltro = "Regiões";
  let txtResultados = "13 Resultados";
  let txtFiltroSecundario = "Novos v";

  let titulo1 = "Ionia";
  let desc1 = "Preciso de ajuda para salvar o meu povo da invasão de Noxus. Qualquer contribuição é bem-vinda!";
  let titulo2 = "Noxus";
  let desc2 = "Procurando ajuda para fortalecer nossas defesas e expandir nosso território. Junte-se a nós para conquistar Runeterra!";
  let titulo3 = "Salve Runeterra";
  let desc3 = "Ajude Ryze a parar esta guerra";
  
  let valorDoacao = "1350 RP";
  let txtInput = "Entre em contato com as regiões.";
  let txtBotao = "Escolha";

  let img1 = require('./img/Ionia.jpg');
  let img2 = require('./img/Darius.jpg');
  let img3 = require('./img/Ryze.jpg');
